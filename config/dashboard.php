...
include "config.php";
    ...
    public $indexing_id;
      ...
      /*** For getting the articlelisttype_data ***/
       ...
       ///*** for getting journal_articles  by id***/
        public $article_name;
        public $article_short_name;
        public $article_type;
        ...
        public $country_name;
        public $pdf_link;
        public $full_text_link;
        public $artical_content;
        public $articleabstract;
        public $abstract_link;
        public $supplimentary_link;
        public $articlekeywords;
        public $start_page_number;
        public $end_page_number;
        public $year;
        public $month;
        public $astatus;
        public $articleissn_number;
     ...
     /*** for login process ***/
		public function check_login($emailusername, $password){
			...
			$sql2="SELECT admin_id from admin WHERE name='$emailusername' and password='$password'";
    	...
    	public function get_adminlist(){
            ...
            echo '<tr>
                ...
                <td class="text-center">
                   <a href="about_admin.php?id='.$adminlist_data["admin_id"].'" title="Edit"><i class="fa fa-edit"></i></a>
                 </td>
                 <td class="text-center">
                     <a href="delete.php?id='.$adminlist_data["admin_id"].'&type=admin" title="Delete"><i class="fa fa-trash-o"></i></a>
                 </td>
              </tr>';
            }
            return true;
    ...
    /*** for indexing count ***/
    	...
    	public function get_journallist(){
            ...
            <div class="panel">
              <figure class="overlay overlay-hover animation-hover">
                <img class="caption-figure overlay-figure" src="../edelweiss/upload/journal_logos/'.$journallist_data["journal_header_img"].'" style="height:180px;width:270px;">
                <figcaption class="overlay-panel overlay-background overlay-fade text-center vertical-align">
                  <div class="btn-group">
                    <a href="about_journal.php?journal_id='.$journallist_data["id"].'" class="btn btn-icon btn-pure btn-default" title="Edit"
                ...
                <div class="text-justify" title="Journal Title" style="height:60px"><b>'.$journallist_data["journal_title"].'</b></div>
            </div>
          </li>';
            }
            return true;
        ...
        /*** Add_Indexing ***/
        public function add_indexing($img_name,$indexlogo_link,$indexlogo_description){
          
          
            $sql20 = "insert into indexing(index_logo,logo_description,link,added_by,added_on) values(' $img_name','$indexlogo_description','$indexlogo_link',1,NOW())";
        ...
        /*** Add_Journals ***/
        public function add_journal($journal_title,$j_journal_logo,$j_journal_image,$journal_s_name,$journal_issn_no,$journal_email,$journal_url,$manuscript_url,$guidelines_url,$paper_url,$youtube_link,$journal_short_desc,$home_page,$aims_scope_page,$instruct_author,$submit_manuscript,$special_issue_guide,$meta_keywords,$meta_desc,$username,$pass,$cpass){
          echo    $sqladd_journal ="insert into journal(journal_title,journal_header_img,journal_img,journal_short_name,issn_number,journal_emailid,journal_url,journal_manuscript_link,journal_guidelines_url,journal_page_url,journal_youtube_url,journal_short_description,journal_home_page,journal_aim_scope,journal_instruction,journal_menuscript,journal_special_issue_guide_lines,journal_meta_key,journal_meta_desc) values ('$journal_title','$j_journal_logo','$j_journal_image','$journal_s_name','$journal_issn_no','$journal_email','$journal_url','$manuscript_url','$guidelines_url','$paper_url','$youtube_link','$journal_short_desc','$home_page','$aims_scope_page','$instruct_author','$submit_manuscript','$special_issue_guide','$meta_keywords','$meta_desc')";
    $resultadd_journal= mysqli_query($this->db,$sqladd_journal);
    return $resultadd_journal;
}
        /*** for updating the journal ***/
        public function update_journal($id,$j_image,$j_logo,$journal_title,$journal_s_name,$journal_issn_no,$journal_email,$journal_url,$menuscript_url,$guidelines_url,$paper_url,$youtube_link,$journal_short_desc,$journal_home_page,$journal_aim_scope,$instruction_author,$journal_menuscript,$special_issue_guidelines,$meta_keywords,$meta_desc){
                  $sql27 = "update journal set issn_number='$journal_issn_no',journal_emailid='$journal_email',journal_url='$journal_url',journal_manuscript_link='$menuscript_url',journal_guidelines_url='$guidelines_url',journal_page_url='$paper_url',journal_youtube_url='$youtube_link',journal_header_img='$j_logo',journal_title='$journal_title',journal_short_name='$journal_s_name',journal_meta_key ='$meta_keywords', journal_meta_desc='$meta_desc', journal_img='$j_image',journal_home_page='$home_page',journal_aim_scope ='$aims_scope_page', journal_instruction ='$instruct_author',journal_menuscript='$submit_menuscript' , journal_special_issue_guide_lines='$special_issue_guide',journal_short_description ='$journal_short_desc',modified_on= NOW(),modified_by = 1 where id='$id'";
...
/***  update indexing ***/
public function update_indexing($id,$indexing_image,$index_link,$index_logo_description){
  echo  $sql29 = "update indexing set index_logo='$indexing_image',logo_description='$index_logo_description',link='$index_link',modified_by=1,modified_on=NOW() where indexing_id = '$id'";
    ...
    return $result29;
        ...
        public function get_editors($journal_id){
          $sql32 = "select * from editors where journal_id='$journal_id'";
          ...
          while($editor_data = mysqli_fetch_array($result32)){
            ...
            <td class="text-center">
               <a href="about_editor.php?editor_id='.$editor_data['editor_id'].'" title="Edit"><i class="fa fa-edit"></i></a>
             </td>
             <td class="text-center">
                 <a href="delete.php?editor_id='.$editor_data['editor_id'].'" title="Delete"><i class="fa fa-trash-o"></i></a>
             </td>
          </tr>
            ';
          }
        ...
        public function get_keywords($id){
              $sql35 = "select * from keywords where journal_id='$id'";
              $result35 = mysqli_query($this->db,$sql35);
              while($keywordsdata = mysqli_fetch_array($result35)){
                ...
                <td class="text-center">
                 ...
                 <td class="text-center">
                     <a href="delete.php?keyword_id='.$keywordsdata['keyword_id'].'" title="Delete"><i class="fa fa-trash-o"></i></a>
                 </td>
              </tr>
                ';
              }
      ...
      public function getjournal_reviews($journal_id){
        $sql40 = "select * from reviewer where journal_id='$journal_id'";
        ...
        while($reviewsdata = mysqli_fetch_array($result40)){
          ...
          <td class="text-center">
           ...
           <td class="text-center">
               <a href="delete.php?review_id='.$reviewsdata['review_id'].'" title="Delete"><i class="fa fa-trash-o"></i></a>
           </td>
        </tr>
          ';
        }
      ...
      /*** ***/
       public function get_review_journal($id,$journal_id){
         $sql41 = "select * from reviewer where review_id='$id' and journal_id ='$journal_id' ";
      ...
      public function  update_reviewerdata($id,$journal_id,$rname,$runiversityname,$rdesignation,$rcountry,$remail,$description){
        $sql42 = "update reviewer set journal_id='$journal_id',name='$rname',university_name='$runiversityname',reviewer_designation='$rdesignation',country='$rcountry',email='$email',description='$description' where review_id='$id' ";
      ...
      public function add_journal_article($journal_id,$volume_number,$issue_number,$status,$month,$year,$article_title,$article_short_name,$article_type,$doi_number,$doi_link,$university_name,$country,$author_name,$pdf_link,$full_text_link,$full_text,$aabstract,$abstract_link,$supplimentary_link,$enter_keywords,$starting_page_number,$ending_page_number,$enter_issn){
                                $sql45 = "insert into articals(journal_id,artical_name,artical_short_name,artical_type_id,artical_number,doi_number,doi_link,author_names,university_name,country_name,pdf_link,full_text_link,artical_content,abstract,abstract_link,supplimentry_link,keywords,starting_page_number,ending_page_number,issn_number,volume_number,issue_number,added_by,added_on,year,month,status) values('$journal_id','$article_title','$article_short_name','$article_type','$issue_number','$doi_number','$doi_link','$author_name','$university_name','$country','$pdf_link','$full_text_link','$full_text','$aabstract','$abstract_link','$supplimentary_link','$enter_keywords','$starting_page_number','$ending_page_number','$enter_issn','$volume_number','$issue_number',1,NOW(),'$year','$month','$status')";
                                $result45 = mysqli_query($this->db,$sql45);
                                return $result45;
      }
      ///*** showing all articles ***///
      public function get_journal_articles($id){
               $sql46 = "select * from articals where journal_id='$id'";
               ...
               while($articledata = mysqli_fetch_array($result46)){
                ...
                <td class="text-center">
                 ...
                 <td class="text-center">
                     <a href="delete.php?article_id='.$articledata['artical_id'].'" title="Delete"><i class="fa fa-trash-o"></i></a>
                 </td>
              </tr>
                       ';
               }
      ...
      public function get_journal_articles_byid($id){
        ...
        public function get_article_status($journal_id){
          $sql50 = "select * from articals where journal_id='$journal_id'";
 ...
 public function add($j_image,$text){
                      $sql24 = "insert into indexing(index_logo,logo_description) values ('$j_image','$text')";
                      $result24 = mysqli_query($this->db,$sql24);
                      return $result24;               
        }
