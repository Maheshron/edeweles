...
if(isset($_REQUEST['submit'])){
 ...
 $a =  $user->add_articletype($article_name);
  if($a){
    header("Location:view_articletypes.php");
  }
  else{
        ...
        <div class="panel-body container-fluid">
            ...
            <div class="row">
                <div class="form-group col-md-12">
                        ...
                        <input type="text" class="form-control" id="inputBasicFirstName" name="addarticle" autocomplete="off">
                </div>
