          ...
          <div class="row row-lg">
            ...
            <div class="row">
                ...
                <div class="form-group col-md-12">
                        ...
                        <input type="text" class="form-control" name="rcountry" id="inputBasicFirstName" value="<?php echo $user->reviewercountry; ?>" autocomplete="off">
                </div>
                <div class="form-group col-md-12">
               ...
               <div class="form-group col-md-12">
                ...
                <div class="form-group col-md-12 text-center">
                      <button type="submit" name="submit" class="btn btn-primary">Save Review</button>
                </div>
