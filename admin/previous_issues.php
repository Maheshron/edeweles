        ...
        <div class="panel-body">
          <table class="table table-hover table-bordered dataTable  w-full" id="exampleTableSearch">
            ...
            <tbody>
              <tr>
                <td>
                    <b>Volume 3, Issue 1 </b><br>
                     <div class="container" style="padding:10px">lysulin-testing-how-pharmacist-help-diabetes-better-health <br>
                    doi: https://doi.org/10.33805/2638-812X.114 <br>
                    John F Burd</div>
                  </td>
                
                <td class="text-center">
                   <button class="btn mt-2 fixbtn" title="Edit" > Move To Articleinpress</button>
                     <button class="btn mt-2 fixbtn" title="Edit" > Move To Previous Issues</button>
                     <button class="btn mt-2 fixbtn" title="Edit" > Move To Special Issues</button>
                 </td>
