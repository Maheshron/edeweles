  ...
  <nav class="site-navbar navbar navbar-default navbar-fixed-top navbar-mega navbar-inverse bg-indigo-600"
    ...
    <div class="navbar-header">
      ...
      <div class="navbar-brand navbar-brand-center">
        <img class="navbar-brand-logo" src="assets/images/logo.jpg" title="Remark" style="width:110px;">
      </div>
  ...
  <div class="site-menubar site-menubar-light">
    <div class="site-menubar-body">
      <ul class="site-menu" data-plugin="menu">
        ...
        <li class="site-menu-item has-sub">
          <a href="article_status.php?journal_id=<?php echo $journal_id; ?>">
                    <i class="site-menu-icon wb-thumb-up" aria-hidden="true"></i>
                    <span class="site-menu-title">Article status</span>
                </a>
