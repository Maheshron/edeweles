            ...
            <div class="row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <select class="form-control" name="country">
                       ...
                       <option value="India" <?php if($user->country_name == "India"){ ?> selected <?php } ?>>India</option>
                       <option value="Canada" <?php if($user->country_name == "Canada"){ ?> selected <?php } ?>>Canada</option>
                       <option value="Australia" <?php if($user->country_name == "Australia" ){ ?> selected <?php } ?> > Australia</option>
                    </select>
                </div>
                
                <div class="form-group col-md-12">
                        <label class="form-control-label" for="inputBasicFirstName">Authors names</label>
                       <textarea id="summernote" data-plugin="summernote" name="author_name"><?php echo $user->author_names;?></textarea>
                </div>
                <div class="form-group col-md-6">
                 ...
                 <div class="form-group col-md-12">
                       ...
                       <textarea id="summernote" name="full_text" data-plugin="summernote">
                       <?php echo $user->artical_content; ?>
                       </textarea>
                </div>
                <div class="form-group col-md-12">
                        <label class="form-control-label" for="inputBasicFirstName">Abstract </label>
                       <textarea id="summernote" name="aabstract" data-plugin="summernote">
                ...
                <div class="form-group col-md-6">
                 ...
                 <div class="form-group col-md-12">
                       ...
                       <textarea id="summernote" data-plugin="summernote" name="enter_keywords">
