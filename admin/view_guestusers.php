  ...
  <div class="page">
    <div class="page-header">
      ...
      <div class="page-header-actions">
        <a class="btn btn-primary btn-outline  btn-sm" href="">
        <i class="icon wb-plus" aria-hidden="true"></i>
        <span class="hidden-sm-down"><b>Add Guest Users</b></span>
      </a>
      </div>
    </div>
      ...
      <div class="panel">
        ...
        <div class="panel-body">
          <table class="table table-hover table-bordered dataTable  w-full" id="exampleTableSearch">
            ...
            <tbody>
              <tr>
                <td> Neurophysiology and Rehabilitation (ISSN: 2641-8991)</td>
                <td>Dr. George John</td>
                <td>gjohn@nic.in</td>
                <td>Research Personnel</td>
                <td>Other</td>
                <td>Kindly give me the email id of Davide Vito Moretti, Editor in chief</td>
