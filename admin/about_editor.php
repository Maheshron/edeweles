            ...
            <div class="row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <select class="form-control" name="countryname" >
                       ...
                       <option value="<?php echo $user->countryname; ?>"><?php echo $user->countryname; ?></option>
                    </select>
                </div>
                 <div class="form-group col-md-6">
                ...
                <div class="form-group col-md-12">
                 ...
                 <div class="form-group col-md-12">
                       ...
                       <textarea id="summernote" name="network"  data-plugin="summernote"><?php echo $user->network; ?></textarea>
                </div>
                <div class="form-group col-md-12">
                        <label class="form-control-label" for="inputBasicFirstName">Biography </label>
                       <textarea id="summernote" name="biography"  data-plugin="summernote"><?php echo $user->biography; ?></textarea>
                </div>
                 <div class="form-group col-md-12">
                        <label class="form-control-label" for="inputBasicFirstName">Research Interest</label>
                       <textarea id="summernote" name="researchinterest"  data-plugin="summernote"><?php echo $user->researchinterest; ?></textarea>
                </div>
                <div class="form-group col-md-12">
                        <label class="form-control-label" for="inputBasicFirstName">Interview </label>
                       <textarea id="summernote" data-plugin="summernote" name="interview"><?php echo $user->interview; ?></textarea>
                </div>
