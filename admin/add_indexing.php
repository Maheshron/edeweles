          ...
          <div class="row row-lg">
            ...
            <div class="row">
                <div class="form-group col-md-12">
                        ...
                        <input type="text" class="form-control" id="inputBasicFirstName" name="indexlogo_link" autocomplete="off">
                </div>
               <div class="form-group col-md-12">
                        <label class="form-control-label" for="inputBasicFirstName">Logo Description </label>
                    
                       <textarea id="summernote" data-plugin="summernote"   name="indexlogo_description"></textarea>
      ...
      $temp_indexing_image = $_FILES['img_name']['tmp_name'];
       ...
       $indexing_image_extension = pathinfo($indexing_image, PATHINFO_EXTENSION);
          if(!in_array($indexing_image_extension,$allowed)){
             ...
             $result = $user->add_indexing($j_image,$indexlogo_link,$indexlogo_description);
        if($result){
