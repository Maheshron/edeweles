          ...
          <div class="row row-lg">
            ...
            <div class="col-xl-4 col-md-6">
              ...
              <div class="example-wrap">
                ...
                <div class="example">
                  <input type="file" id="input-file-now" name="img_name" data-plugin="dropify" data-default-file="global/photos/view-7-960x640.jpg"/>
                </div>
              </div>
              <!-- End Example Default -->
            </div>
            ...
            <div class="row">
                <div class="form-group col-md-12">
                       ...
                       <textarea id="summernote" data-plugin="summernote" name="text">
                       </textarea>
                </div>
...
<?php 
    ...
    if(isset($_REQUEST['submit'])){
      extract($_REQUEST);
       $j_image= $_FILES['img_name']['name'];
       $temp_j_image = $_FILES['img_name']['tmp_name'];
        $allowed = array('jpeg','jpg','gif','png','JPEG','JPG','GIF','PNG');
      
        $j_image_extension = pathinfo($j_image, PATHINFO_EXTENSION);
           if(!in_array( $j_image_extension,$allowed)){
                  ...
                  move_uploaded_file($temp_j_image,"../edelweiss/upload/$j_image");
              
        echo $j_image;
        $result = $user->add($j_image,$text);
        if($result){
