          ...
          <div class="row row-lg">
            ...
            <div class="col-xl-4 col-md-6">
              ...
              <div class="example-wrap">
                ...
                <div class="example">
                  <input type="file" name="profile_pic" id="input-file-now" data-plugin="dropify" data-default-file="global/photos/view-7-960x640.jpg"/>
                </div>
            ...
            <div class="col-xl-4 col-md-6">
              ...
              <div class="example-wrap">
                ...
                <div class="example">
                  <input type="file" name="university_logo" id="input-file-now-custom-1" data-plugin="dropify" data-default-file="global/photos/view-7-960x640.jpg"/>
                </div>
                  <h6 class="text-center">Note: Photo must be less than 3 kilobytes and dimensions 100X100.</h6>
              </div>
            ...
            <div class="row">
                <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" id="inputBasicFirstName" name="editor_firstname" autocomplete="off">
                </div>
                <div class="form-group col-md-6">
                        <label class="form-control-label" for="inputBasicFirstName">Editor Last Name</label>
                        <input type="text" class="form-control" id="inputBasicFirstName" name="editor_lastname" autocomplete="off">
                </div>
                 <div class="form-group col-md-6">
                        <label class="form-control-label" for="inputBasicFirstName">Editor University Name </label>
                        <input type="text" class="form-control" id="inputBasicFirstName" name="editor_universityname" autocomplete="off">
                </div>
                <div class="form-group col-md-6">
                        <label class="form-control-label" for="inputBasicFirstName">Editor Email Address </label>
                        <input type="text" class="form-control" id="inputBasicFirstName" name="editor_emailaddress" autocomplete="off">
                </div>
                 <div class="form-group col-md-6">
                        <label class="form-control-label" for="inputBasicFirstName">Editor Designation</label>
                        <input type="text" class="form-control" id="inputBasicFirstName" name="editor_designation" autocomplete="off">
                </div>
                <div class="form-group col-md-6">
                 ...
                 <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" id="inputBasicFirstName" name="editor_searchuniversity" autocomplete="off">
                </div>
                <div class="form-group col-md-6">
                        <label class="form-control-label" for="inputBasicFirstName">University Url</label>
                        <input type="text" class="form-control" id="inputBasicFirstName" name="editor_universityurl" autocomplete="off">
                </div>
                <div class="form-group col-md-6">
                 ...
                 <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" id="inputBasicFirstName" name="editor_profileurl" autocomplete="off">
                </div>
                <div class="form-group col-md-6">
                        <label class="form-control-label" for="inputBasicFirstName">Editor Interview Url</label>
                        <input type="text" class="form-control" id="inputBasicFirstName" name="editor_interviewurl" autocomplete="off">
                </div>
                <div class="form-group col-md-6">
                ...
                <div class="form-group col-md-12">
                 ...
                 <div class="form-group col-md-12">
                        <label class="form-control-label" for="inputBasicFirstName">Network </label>
                       <textarea id="summernote" name="editor_network" data-plugin="summernote"></textarea>
                </div>
                <div class="form-group col-md-12">
                        <label class="form-control-label" for="inputBasicFirstName">Biography </label>
                       <textarea id="summernote" name="editor_biography"  data-plugin="summernote"></textarea>
                </div>
                 <div class="form-group col-md-12">
                        <label class="form-control-label" for="inputBasicFirstName">Research Interest</label>
                       <textarea id="summernote" name="editor_researchinterest" data-plugin="summernote"></textarea>
                </div>
                <div class="form-group col-md-12">
                        <label class="form-control-label" for="inputBasicFirstName">Interview </label>
                       <textarea id="summernote" name="editor_interview" data-plugin="summernote"></textarea>
                </div>
...
if(isset($_REQUEST['submit'])){
  ...
  extract($_REQUEST);
       ...
       $profile_image_extension = pathinfo($profile_image, PATHINFO_EXTENSION);
        ...
        if($result){
         header('Location:add_editors.php');
